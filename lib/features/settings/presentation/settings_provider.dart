...
String audioQualityToken(AudioQualityOption quality) => switch (quality) {
...
abstract class _PersistedSettingNotifier<T> extends StateNotifier<T> {
  ...
  Future<bool> _persist(
    ...
    try {
      ...
      _writeTail = pendingWrite.then<void>((_) {}, onError: (_, __) {});
...
class AudioQualityNotifier
  ...
  AudioQualityNotifier({
    ...
    _load((storage) {
      ...
      return index == null
          ? null
          : AudioQualityOption.values[index.clamp(
              0,
  ...
  Future<void> setQuality(AudioQualityOption quality) async {
    ...
    final token = audioQualityToken(quality);
    try {
