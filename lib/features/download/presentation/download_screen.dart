...
class _DownloadScreenState extends ConsumerState<DownloadScreen> {
          ...
          actions: [
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                ...
                if (value == 'clear_failed') _clearFailed(context, ref);
              },
              itemBuilder: (_) => [
                PopupMenuItem(
                  value: 'pause_all',
  ...
  Widget _buildStatItem(Widget value, String label) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        value,
  ...
  void _playDownloaded(WidgetRef ref, DownloadTask task) {
    ...
    final items = completedTasks.map((t) {
      final uri = PlaybackCacheService.toPlayableUri(t.savePath!);
  ...
  void _clearFailed(BuildContext context, WidgetRef ref) {
    final tasks = ref.read(downloadTasksProvider);
    final failed = tasks
