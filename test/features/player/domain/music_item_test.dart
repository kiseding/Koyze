...
void main() {
  ...
  group('MusicItem', () {
    ...
    test('equality uses source-aware identity while preserving raw id', () {
      ...
      expect(music1, isNot(otherPlatform));
      expect(music1.id, otherPlatform.id);
      expect({music1, otherPlatform}, hasLength(2));
    });
  });
}
